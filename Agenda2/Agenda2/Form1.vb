Public Class Form1
    Private Sub Agenda01BindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles Agenda01BindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Agenda01BindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.Agenda01DataSet)
